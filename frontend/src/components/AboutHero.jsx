  ...
  return (
    <section className="relative h-[70vh] md:h-[70vh] w-full overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1675851143055-23ae996bb212?q=80&w=1613&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`
        }}
      />
