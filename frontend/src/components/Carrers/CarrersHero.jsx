  ...
  return (
    <section className="relative h-[70vh] md:h-[70vh] w-full overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('https://plus.unsplash.com/premium_photo-1683120996006-c6ea2a3da4b1?q=80&w=1113&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`
        }}
      />
